...
const { newMessage, fillQueryTemplate } = require('../helpers');
...
async function processAction(msg, cfg) {
   ...
   */
    ...
    const realQuery = fillQueryTemplate(query, transformedMsg.payload);
    ...
    oihMeta.recordUid = JSON.stringify(reply);
